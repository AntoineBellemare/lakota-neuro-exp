...
expName = 'lakota_symbols_triggerhub'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\skite\\Documents\\Github\\lakota-neuro-exp\\lakota_symbols_triggerhub_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_3 = visual.TextStim(win=win, name='text_3',
        text='Stay still for the next 1 minute and look at the fixation cross.\nPlease minimize blinks and relax yourself.',
        font='Arial',
